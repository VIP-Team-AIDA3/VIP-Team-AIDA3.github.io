...
- A **frequentist** says: "if $b$ is some fixed number. I don't know it, but it doesn't have a probability distribution — my *measurements* do. I'll compute an estimate $\hat{b}$ and describe how that estimate would vary if I repeated this whole calibration run many times." 
